...
;(function (global, factory) {
    ...
    // Setting the hour should keep the time, because the default explicitly
...
module.exports = function(Chart) {
	...
	Chart.Animation = Chart.Element.extend({
		...
		onAnimationProgress: null, // default specified callback to fire on each step of the animation
		onAnimationComplete: null // default specified callback to fire when the animation finishes
	});
...
module.exports = function() {
	...
	//Globally expose the defaults to allow for default updating/changing
	Chart.defaults = {
		global: {
			responsive: true,
	...
	Chart.Tooltip = Chart.Element.extend({
		...
		update: function(changed) {
			...
			if (active.length) {
				...
				// If the default provided a sorting function, use it to modify the tooltip items
				if (opts.itemSort) {
		...
		*/
		...
		determineDataLimits: function() {
			...
			if (me.options.ticks.min !== undefined) {
				// default specified min value
				findIndex = helpers.indexOf(labels, me.options.ticks.min);
				me.minIndex = findIndex !== -1 ? findIndex : me.minIndex;
			}

			if (me.options.ticks.max !== undefined) {
				// default specified max value
...
module.exports = function(Chart) {
	...
	Chart.LinearScaleBase = Chart.Scale.extend({
		handleTickRangeOptions: function() {
			...
			// do nothing since that would make the chart weird. If the default really wants a weird chart
